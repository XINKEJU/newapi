...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/sms/send", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), controller.SendSMSVerification)
		apiRouter.POST("/sms/verify", middleware.CriticalRateLimit(), controller.VerifySMSCode)
		...
		// VK ID SDK login (frontend exchanges code via SDK, sends access_token to backend)
		apiRouter.POST("/oauth/vk_sdk", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.HandleVKSDKLogin)
		...
		apiRouter.GET("/oauth/telegram", middleware.CriticalRateLimit(), controller.TelegramOAuthRedirect)
